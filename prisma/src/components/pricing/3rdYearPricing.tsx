    ...
    <div className="flex-col flex justify-center items-center">
      ...
      {/* <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-green-50 to-white p-6"> */}
        ...
        <div className="w-full md:w-80 p-6 bg-gradient-to-br from-gray-100 to-green-100 pricing rounded-xl shadow-lg mt-8">
          <h3 className="text-gray-100 font-medium bg-lime-700 py-1.5 text-center rounded-md mb-5">3rd Year</h3>

          <h3 className="text-gray-700 font-medium mb-3">END-SEM PREP PLAN</h3>
          <p className="text-4xl font-bold text-green-700 pricing-text">₹35
        ...
        <Link href="/pricing/qr2"  > <button className="mt-6 bg-[#325780] text-white px-6 py-2 rounded-full shadow-md hover:bg-[#1f5fa8] transition">
          ACTIVE NOW        </button>
        </Link>
      </div>
    //   <Footer />
...
export default ThirdPricingPlans;
