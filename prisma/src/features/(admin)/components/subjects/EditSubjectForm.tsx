...
function EditSubjectForm({ defaultValues, SEMESTER_YEARS, COURSES, EDUCATION_YEARS, SUBJECT_CREDITS, BRANCHES, SCHEMES, isLoading, SUBJECT_TYPE }: IAddSubjectForm) {
    ...
    return (
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-3">
                ...
                <SubmitButton title="Edit Subject" disabled={loading} />
            </form>
        </Form>
    );
