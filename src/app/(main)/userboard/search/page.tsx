...
import { Search, FileText, X, FilePdf, ExternalLink } from "lucide-react"
import { Badge } from "@/components/ui/badge"
import { cn } from "@/lib/utils"

// Add PDF URLs to your dummy results
const dummyResults = [
  {
    id: 1,
      ...
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-10">
          ...
          <p className="text-muted-foreground max-w-md mx-auto">
            Find your documents instantly with our modern search interface
          </p>
        </div>
          ...
          {results.length > 0 ? (
            results.map((result, index) => (
              ...
              >
                <a
                  href={result.pdfUrl}
                  onClick={(e) => openPdf(result.pdfUrl, e)}
