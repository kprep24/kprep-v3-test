...
import { useModifyPyq } from '../../api/pyq/useModifyPyq';
...
function EditPyq({ defaultValues }: IAddPyq) {
    ...
    const editPyq = useModifyPyq(pyqId!);
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-3">
                ...
                <div className="first_row flex gap-4">
                    ...
                    <SelectField
                        ...
                        label={'Select Year'}
                        form={form.control}
                        disabled={durationList.length == 0 || editPyq.isPending}
                    />
                    <SelectField
                        ...
                        form={form.control}
                        disabled={extractSubjectList.length == 0 || editPyq.isPending}
                    />
                </div>
                ...
                {!pyqId && <div className="file_uploader_wrapper">
                    <div className="resources_upload_filed">
                        <input disabled={editPyq.isPending} type="file" accept="application/pdf" onChange={handlePyq} />
                ...
                <div className="file_uploader_wrapper">
                    <div className="resources_upload_filed">
                        <input disabled={editPyq.isPending} type="file" accept="application/pdf" onChange={handleSol} />
